      ...
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          ...
          <div className="hidden xl:flex relative ">
            ...
            />
            <div className="bg-hero_shape2_light dark:bg-hero_shape2_dark w-[510px] h-[499px] bg-no-repeat absolute top-5 -right-2">
       <DevImg
  containerStyles="bg-hero_shape w-full h-full bg-no-repeat relative bg-bottom [&>img]:translate-y-1"
