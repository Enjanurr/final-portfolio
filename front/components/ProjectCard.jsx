...
// this is a children compononent of work js
// we use project here instead of projectdata because the array is already used in the parent element
const ProjectCard = ({ project }) => {
  return (
    <Card className="group overflow-hidden relative ">
      <CardHeader className='p-0'>
        {/* this div cuts off the image that exceed using the overflow-hidden */}
        <div className="relative w-full h-[300px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light xl:bg-[110%] xl:bg-no-repeat overflow-hidden">
         ...
         {/*   <Link
           ...
           justify-center items-center scale-0
